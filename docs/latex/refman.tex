...
\vspace*{7cm}
\begin{center}%
{\Large Estruturas de Dados \\[1ex]\large 1.\+0 }\\
\vspace*{1cm}
...
\input{structFIFO}
\input{structLiContigua}
\input{structLiEncadeada}
\input{structmatriz}
\input{structTipoArvore}
\input{structValor}
\chapter{Arquivos}
\input{aritmeticaPonteiros_8h}
\input{buscas_8h}
\input{ListaEncadeada_8h}
\input{Main_8h}
